...
- **For-Profit Company**
  - Providers of hardware and other potential services to users of the open source design
  - May be any combination of companies that choose to provide hardware and services